...
function responsiveMenu() {
    ...
    // Desplazamiento a la sección habilidades-mobile en dispositivos móviles
    if (window.innerWidth <= 768) { // Ajusta este valor según tu diseño responsive
        if (x.className === "responsive") {
            scrollToSection("habilidades-mobile");
        }
    }
}
...
function responsiveMenu() {
    ...
    // Desplazamiento a la sección habilidades-mobile en dispositivos móviles
    if (window.innerWidth <= 801) { // Ajusta este valor según tu diseño responsive
        if (x.className === "responsive") {
            scrollToSection("habilidades-mobile");
        }
    }
